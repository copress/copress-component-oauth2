var async = require('async')
    ...
    , debug = require('debug')('sycle:oauth2')
...
function setupResourceServer(app, options, models) {
    ...
    function authenticate(options) {
        ...
        var authenticators = [
            passport.authenticate(['sycle-oauth2-bearer', 'sycle-oauth2-mac'],
                options)];
