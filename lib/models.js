...
module.exports = function (sapp, options) {
    ...
    var Application = models[options.applicationModel] || models['Application'];
    ...
    AuthorizationCodes.delete = function(id, done) {
        models.OAuthAuthorizationCode.destroyById(id, done);
    };
